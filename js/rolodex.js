/**
 * Rolodex Form Handler - OFF-THE-RECORD
 * =====================================
 * Handles form submission for the standalone Rolodex/guestbook page.
...
(function() {
    ...
    // DOM Elements
    var form = document.getElementById('rolodexForm');
    ...
    function handleSubmit(e) {
        ...
        if (typeof OTR_ANALYTICS_CONFIG === 'undefined' || !OTR_ANALYTICS_CONFIG.trackingEnabled) {
            ...
            console.log('[Rolodex] Tracking disabled. Payload:', JSON.stringify(payload, null, 2));
        ...
        // Get endpoint URL
        var endpoint = OTR_ANALYTICS_CONFIG.rolodexUrl || OTR_ANALYTICS_CONFIG.analyticsScriptUrl;
        ...
        .then(function() {
            ...
            console.log('[Rolodex] Submission sent');
            isSubmitting = false;
            setButtonState(false, originalButtonText);
            resetForm();
            showSuccess();
        ...
        .catch(function(error) {
            console.error('[Rolodex] Submission failed:', error);
            isSubmitting = false;
            setButtonState(false, originalButtonText);
    ...
    function init() {
        if (!form) {
            console.warn('[Rolodex] Form not found');
            return;
        }
        ...
        console.log('[Rolodex] Initialized');
    }
