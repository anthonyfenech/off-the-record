...
<p class="index-name">Ben</p>
<p class="index-name">Bernstein</p>
...
<p class="index-name">Lulu</p>
<p class="index-name">Lynn</p>
...
<h3 class="index-letter">PSEUDONYMS</h3>
<p class="index-name">Boss</p>
<p class="index-name">Buddy</p>
<p class="index-name">Coach Nate</p>
<p class="index-name">Deep Throat</p>
<p class="index-name">Highest Source In The Land</p>
<p class="index-name">Internet Stalker</p>
<p class="index-name">Mr. Sports Editor</p>
<p class="index-name">Mr. Unethical</p>
<p class="index-name">Old Pal</p>
<p class="index-name">Rival Cohort</p>
<p class="index-name">Rival Exec</p>
<p class="index-name">Scuttlebutt</p>
<p class="index-name">Sour Shoes</p>
<p class="index-name">Tipster</p>
<p class="index-name">Top Scout</p>
<p class="index-name">Twitter Guy</p>
<p class="index-name">Union Rep</p>
</div>`,
    wordCount: 0,
    parent_id: null,
    hidden: false,
