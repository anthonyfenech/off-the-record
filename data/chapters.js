...
<p>"Buckle up. Midway runways are short, and landings can be quite aggressive—make sure your seatbelt is tight."</p>`,
    ...
    },
    {
        ...
        content: `
            ...
            <p class="block-quote"><em>"'It was not a chokehold,' Allen's agent Tom Shaer said—a claim confirmed by two other persons with knowledge of the situation."</em></p>
    ...
    // 2019 SEASON CHAPTERS (25-30)
    {
        ...
        content: `
            ...
            <p class="block-quote"><em>"And all of a sudden the ball was there, like the Mystic River Bridge, suspended out in the black of the morning.</em></p>
            <p class="block-quote"><em>"When it finally crashed off the mesh attached to the left field foul pole, one step after another the reaction unfurled: from Carlton Fisk's convulsive leap to John Kiley's booming of the 'Hallelujah Chorus' to the wearing off of the numbness to the outcry that echoed across the cold New England morning.</em></p>
            <p class="block-quote"><em>"At 12:34 <span class="small-caps">A.M.</span>, in the 12th inning, Fisk's histrionic home run brought a 7-6 end to a game that will be the pride of historians in the year 2525, a game won and lost what seemed like a dozen times, and a game that brings back summertime one more day. For the seventh game of the World Series."</em></p>
    ...
    },
    {
        ...
        content: `
            <p>From: Thomas, Christopher Sent: Tuesday, August 20, 2019 12:15 <span class="small-caps">P.M.</span></p>
            ...
            <p>To: Thomas, Christopher Sent: Tuesday, August 20, 2019 1:28 <span class="small-caps">P.M.</span></p>
            ...
            <p>From: Thomas, Christopher Sent: Tuesday, August 20, 2019 2:05 <span class="small-caps">P.M.</span></p>
            <p>Subject: RE: Tigers today</p>
